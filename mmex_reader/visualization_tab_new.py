...
from visualization_charts_new import (
    create_spending_by_category_chart, create_spending_over_time_chart,
    create_income_vs_expenses_chart, create_top_payees_chart,
    create_asset_distribution_chart, create_monthly_budget_comparison_chart,
    create_transaction_frequency_chart, create_cashflow_chart, create_summary_statistics_widget
)
from ui_config_new import ui_config
...
class VisualizationTab(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        # Current chart type
        self.current_chart_type = "Spending by Category"
    ...
    def show_chart(self, transactions_df):
        ...
        try:
            ...
            chart_functions = {
                ...
                "Top Payees": create_top_payees_chart,
                "Asset Distribution": create_asset_distribution_chart,
                "Budget Comparison": create_monthly_budget_comparison_chart,
                "Transaction Frequency": create_transaction_frequency_chart,
                "Cash Flow": create_cashflow_chart
            }
