"""Configuration Management Module for MMEX Reader Application - Step 2 Refactor.

This step extracts the SettingsPopup UI class to a separate config_ui.py module.
"""
...
# Extracting SettingsPopup to config_ui.py
